...
class BaseEngine(BaseModel, ABC):
    """Base Engine abstract model for any implemented engine of JUTE opterator.
    ...
    author: list[str] = Field(
        ...
        json_schema_extra={
            "title": "Author",
            "description": "An author name of this JUTE configuration template",
        },
    )
    ...
    def handle_execute(self, context: Context) -> Result:
        ...
        object. This method must call from the Jute Operator execute method.
